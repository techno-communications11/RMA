...
const Markets = () => {
  ...
  const getStoresForMarket = async (marketName) => {
    setLoading(true);
    setSelectedMarket(marketName === selectedMarket ? "" : marketName);
  ...
  const handleClickNetPage = (selectedStore) => {
      ...
      <div className="row text-start mb-1">
        ...
        <div className="col-12 col-md text-center me-5">
          ...
          <p className="lead text-muted">
            <FaHeart className="text-pink-400 me-1 pulse-icon" />
                ...
                <Row className="align-items-center">
                  <Col xs={12} sm={6} md={7}>
                    <Card.Title className="d-flex align-items-center mb-2">
                      ...
                      <span className="h4 mb-0 fw-bold text-pink-700 text-capitalize">
                        {market.marketName?.toLowerCase()}
                      </span>
                      <BsFillPatchCheckFill className="ms-2 text-pink-400" />
                    </Card.Title>
                              ...
                              <Card className="store-item h-100 border-0 bg-white hover-scale">
                                <Card.Body className="p-3">
                                  <div className="d-flex justify-content-between align-items-center">
                                    <div>
                                      <FaStore className="text-pink-400 mb-2 store-icon" />
                                      <h6 className="mb-1 text-pink-700 text-capitalize">
